...
if __name__ == "__main__":
    ...
    # load sample rate
    sampleRatePy = arguments.sampleRate

    # compute directories
    pathDataPy = Path(arguments.data)
    pathLapsPy = Path(arguments.laps)
    dirFinalPy = arguments.final

    # call function
    dataCSVsplitting(pathDataPy, pathLapsPy, dirFinalPy, sampleRatePy)
