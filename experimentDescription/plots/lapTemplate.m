...
% Create line
annotation(fig,'line',[0.642187499999999 0.642187499999999],...
    [0.925131117266834 0.108033240997214],'Color',[1 0 0],'LineWidth',1,...
    'LineStyle','-.');

% Create line
annotation(fig,'line',[0.664583333333332 0.664583333333332],...
...
% Create line
annotation(fig,'line',[0.3 0.3],[0.925131117266839 0.10803324099722],...
    'Color',[1 0 0],...
    'LineWidth',1,...
    'LineStyle','-.');

% Create line
annotation(fig,'line',[0.369791666666666 0.369791666666666],...
    [0.925131117266839 0.10803324099722],'Color',[1 0 0],'LineWidth',1,...
    'LineStyle','-.');

% Create line
annotation(fig,'line',[0.386458333333333 0.386458333333333],...
    [0.92513111726684 0.108033240997221],'Color',[1 0 0],'LineWidth',1,...
    'LineStyle','-.');

% Create line
annotation(fig,'line',[0.795833333333333 0.795833333333333],...
    [0.925131117266832 0.108033240997213],'Color',[1 0 0],'LineWidth',1,...
    'LineStyle','-.');

% Create line
annotation(fig,'line',[0.573958333333332 0.573958333333332],...
    [0.925131117266836 0.108033240997217],'Color',[1 0 0],'LineWidth',1,...
    'LineStyle','-.');

% Create line
annotation(fig,'line',[0.500520833333333 0.500520833333333],...
    [0.925131117266836 0.108033240997217],'Color',[1 0 0],'LineWidth',1,...
    'LineStyle','-.');

% Create line
annotation(fig,'line',[0.469791666666666 0.469791666666666],...
    [0.925131117266836 0.108033240997218],'Color',[1 0 0],'LineWidth',1,...
    'LineStyle','-.');

% Create line
annotation(fig,'line',[0.291666666666666 0.291666666666666],...
    [0.92513111726684 0.108033240997222],'Color',[1 0 0],'LineWidth',1,...
    'LineStyle','-.');

% Create line
annotation(fig,'line',[0.177083333333333 0.177083333333333],...
    [0.925131117266844 0.108033240997226],'Color',[1 0 0],'LineWidth',1,...
    'LineStyle','-.');

% Create line
annotation(fig,'line',[0.197395833333333 0.197395833333334],...
...
% Create line
annotation(fig,'line',[0.313020833333333 0.313020833333333],...
    [0.925131117266839 0.10803324099722],'Color',[1 0 0],'LineWidth',1,...
    'LineStyle','-.');

% Create line
annotation(fig,'line',[0.321354166666667 0.321354166666667],...
    [0.925131117266839 0.10803324099722],'Color',[1 0 1],'LineWidth',1,...
    'LineStyle','-.');

% Create line
annotation(fig,'line',[0.754166666666665 0.754166666666666],...
...
annotation(fig,'textarrow',[0.485416666666667 0.485416666666667],...
    [0.848568790397045 0.602031394275162],'TextBackgroundColor',[1 1 1],...
    'String',{'Crossroad between','via Lussemburgo','and via Germania'},...
    'HorizontalAlignment','center',...
    'FontWeight','bold');

% Create textarrow
annotation(fig,'textarrow',[0.518229166666666 0.4921875],...
    [0.772853185595568 0.574330563250231],'TextBackgroundColor',[1 1 1],...
...
annotation(fig,'textarrow',[0.584375 0.584375],...
    [0.772853185595568 0.539242843951985],'TextBackgroundColor',[1 1 1],...
    'String',{'Crossroad between','via Germania and',' via Gran Bretagna'},...
    'HorizontalAlignment','center',...
    'FontWeight','bold');

% Create textarrow
annotation(fig,'textarrow',[0.653125 0.653125],...
    [0.772853185595568 0.667590027700831],'TextBackgroundColor',[1 1 1],...
...
annotation(fig,'textarrow',[0.8421875 0.868229166666667],...
    [0.772853185595568 0.626038781163435],'TextBackgroundColor',[1 1 1],...
    'String',{'Small turn','at the end'},...
    'HorizontalAlignment','center',...
    'FontWeight','bold');
...
annotation(fig,'textarrow',[0.306770833333334 0.306770833333333],...
    [0.847645429362881 0.717451523545706],'TextBackgroundColor',[1 1 1],...
...
annotation(fig,'textarrow',[0.378645833333333 0.379166666666667],...
    [0.847645429362881 0.617728531855956],'TextBackgroundColor',[1 1 1],...
    'String',{'Curve on via','Lussemburgo'},...
    'HorizontalAlignment','center',...
    'FontWeight','bold');
...
% Create textarrow
annotation(fig,'textarrow',[0.205729166666667 0.188541666666667],...
    [0.772853185595568 0.590027700831025],'TextBackgroundColor',[1 1 1],...
...
annotation(fig,'rectangle',...
    [0.316145833333333 0.308402585410896 0.0510416666666667 0.209602954755309],...
    'LineWidth',1.5,...
    'LineStyle','-.');
...
annotation(fig,'textbox',...
    [0.591364583372137 0.428439520320071 0.0520833319363495 0.0249307474546265],...
...
% Create textbox
annotation(fig,'textbox',...
    [0.751520833364377 0.426592798251742 0.0473958320760479 0.0249307474546265],...
    'String',{'RoundTwo'},...
    'LineWidth',1,...
    'HorizontalAlignment','center',...
    'FontWeight','bold',...
...
% Create textbox
annotation(fig,'textbox',...
    [0.315062499999999 0.427199221838477 0.0531249985719721 0.0243243238678924],...
    'String',{'SecondBump'},...
    'LineWidth',1,...
    'HorizontalAlignment','center',...
    'FontWeight','bold',...
