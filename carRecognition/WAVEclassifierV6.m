...
%% PLOT VARIANCE RESULTS FOR EVERY METHODE

for method = 1 : 1

   % compute methode and data name strings
   methodStr = methodNames(rem(5-1, 4) + 1);
   ...
   % create stacked plot and set it up
   statPlot = stackedplot(plotResults, dispVar);
   statPlot.DisplayLabels = dispLab;
   statPlot.XLabel = 'Segment ID';
